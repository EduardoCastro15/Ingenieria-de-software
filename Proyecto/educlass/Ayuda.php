          ...
          <div class="article1"><br>
            ...
            <form class="ayuda">
              <fieldset>    
                <br>                
                <p>
                  Esta aplicación ayudará a profesores para subir sus materiales y poder insertar sus materiales para que el, la o los alumnos 
				  puedan consultar variedad de estos para mejorar su aprendizaje.
                </p>
                <p>
                  Si se te olvida la contraseña deberás ingresar en el enlace ubicado en la barra lateral derecha “Olvidaste Contraseña”, 
				  al ingresar se encuentra datos que te piden para poder restablecer la contraseña o solo indicas tu correo electrónico y 
				  clave de usuari y con ello se va a generar una contraseña provisional, se recomienda después de actualizarla.
                </p> 
                <br>
                <a href="Contacto.php">Contactanos</a><br><br>                             
                <br><br>
              </fieldset>
            </form>                        
          </div> 
