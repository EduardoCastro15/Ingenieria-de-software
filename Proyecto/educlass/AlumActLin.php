      ...
      <div id="contenido">
        ...
        <div id="section">
          <div class="article1"><br>
			...
			<table>
              <tr>
                <th class="colsa" colspan="5">Actividades en Linea</th>
              </tr>
              <tr>
                <th>Fecha</th>
                <th>Nombre Prof</th>
			  ...
			  $gpo=$gpoR['gpo'];
              $result=mysqli_query($conn,"SELECT materiales.Fecha_carga, datos_prof.Nomr_prof, datos_prof.ApP_prof, datos_prof.ApM_prof, materiales.desc_mat FROM materiales INNER JOIN datos_prof ON materiales.no_empleado = datos_prof.no_empleado INNER JOIN datos_alumno ON datos_prof.ID_gpos=datos_prof.ID_gpos WHERE materiales.ID_tipoM=3 AND datos_prof.ID_gpos=datos_alumno.ID_gpo=$gpo;");
