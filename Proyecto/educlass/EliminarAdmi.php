      ...
      <div id="contenido">
        ...
        <div id="section">
          <div class="article1"><br>
			...
			<form style="border-radius: 10em; margin-left: 200px; margin-right: 200px; margin-top: 30px; text-align: center;" action="Includes/ElimAdmi.php" method="POST">
              <fieldset>                
                <label>Usuario a Eliminar</label><br>
                  <select name="clave" id="clave">
                    <option value="0">Seleccione:</option>
                    <?php  
                    require 'Includes/conexion.php';                  
                    $query2 = $conn -> query ("SELECT * FROM `datos_admin`");
                    while ($valores2 = mysqli_fetch_array($query2)) {                      
                      echo '<option value="'.$valores2['clave'].'">'.$valores2['clave'].'</option>';
                    }
                    ?>                                
                  </select><br><br>
				<button type="submit" id="EA" name="EA">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Enviar&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</button>				  
				<br><br>
              </fieldset>
            </form>
			<?php if(isset($_GET['msg']) && $_GET['msg'] == 'true'): ?>
                    <p style="color: red; font-weight: bold; font-size: 25px; text-align: center;">¡Usuario Eliminado!</p>
            <?php endif; ?>				
          </div> 
        </div>        
      </div>
