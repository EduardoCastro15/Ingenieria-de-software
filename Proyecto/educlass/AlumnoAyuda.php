          ...
          <div class="article1"><br>
            ...
            <form class="ayuda">
              <fieldset>    
                <br>                            
                <p>
                  Si presentas una falla durante la estancia en la aplicacion, queja, sugerencia o error; te invitamos a ponerte en contacto con nosotros para brindarte una mejor experiencia.
                </p> 
                <br>
                <a href="AlumnoContacto.php">Contactanos</a><br><br>                             
                <br><br>
              </fieldset>
            </form>                        
          </div> 
