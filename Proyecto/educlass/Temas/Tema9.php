      ...
      <div id="contenido">
        ...
        <div id="section">
          <div class="article1"><br>
            <h3>Tema 9: </h3>
			<p>
				En el cap&iacute;tulo 9 se encuentran ejercicios en los que se aprender&aacute;
				c&oacute;mo crear el diseño de unos manteles, para que posteriormente estos
				se puedan vender, saber cu&aacute;nto se puede obtener por ellos y si se recupera
				la inversi&oacute;n y elegir cu&aacute;l diseño podr&iacute;a tener mejores ventas.
			</p>
			<br>
			<div align="center">
				<img src="Imagenes_Temas/telas.jpg" width="400" height="280" title="Ejemplo de como llenar el Formulario">
            </div>
