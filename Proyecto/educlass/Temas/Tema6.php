      ...
      <div id="contenido">
        ...
        <div id="section">
          <div class="article1"><br>
            <h3>Tema 6: </h3>
			<p>
				En el cap&aacute;tulo 6 se encuentran ejercicios en los que se requiere 
				de un lazo o un cord&oacute;n, para poder hacer las respectivas mediciones 
				que se piden, el primer ejercicio trata sobre asignar las agujetas a 
				los respectivos zapatos que indica en el libro.
			</p>
			<p>
				Otros ejercicios tratan sobre dibujar de distinto color las 
				porter&iacute;as dependiendo su tamaño, y para saber cuanto miden o cu&aacute;l es 
				m&aacute;s grande y cu&aacute;l m&aacute;s chica, de igual manera se requiere de un cord&oacute;n 
				para poder hacer las mediciones.
			</p>
			<br>
			<div align="center"> 
				<img src="Imagenes_Temas/lazo.jpg" width="300" height="230" title="Ejercicio medir con lazo">
				<img src="Imagenes_Temas/porteria.jpg" width="300" height="230" title="Ejercicio medir porter&iacute;as">
            </div>
