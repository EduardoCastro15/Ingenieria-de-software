      ...
      <div id="contenido">
        ...
        <div id="section">
          <div class="article1"><br>
            <h3>Tema 5: </h3>
			<p>
				En mosaicos y configuraciones geom&eacute;tricas el alumno estudiar&aacute; las
				diferentes figuras geom&eacute;tricas que existen, aprender sus nombres, como
				diferenciarlas. Tambi&eacute;n aprender&aacute; a saber que figuras tienen lados rectos
				o curvos y a diferencias estos.
			</p>
			<br>
			<div align="center">
				<img src="Imagenes_Temas/geometria.jpg" width="450" height="290" title="Figuras geom&eacute;tricas">
            </div>
