      ...
      <div id="contenido">
        ...
        <div id="section">
          <div class="article1"><br>
            <h3>Tema 2: </h3>
			<p>
				En el segundo tema de este bloque se aprender&aacute; que objeto pesa m&aacute;s que
				otro y porque sucede esto. Conforme avance este tema el alumno aprender&aacute;
				a distinguir los objetos m&aacute;s pesados y porque es la raz&oacute;n de esto. Todo
				de una forma din&aacute;mica para el alumno.
			</p>
			<br>
			<div align="center">
				<img src="Imagenes_Temas/balanza.jpg" width="450" height="290" title="Ejercicio de medición de peso">
            </div>
