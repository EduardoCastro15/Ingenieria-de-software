      ...
      <div id="contenido">
        ...
        <div id="section">
          <div class="article1"><br>
            <h3>Tema 7: </h3>
			<p>
				En el cap&iacute;tulo 7 se encuentran ejercicios en los que se requiere
				de distintas figuras geom&eacute;tricas, con las cuales se har&aacute; un pequeño
				an&aacute;lisis como ver si giran y c&oacute;mo lo hacen y c&oacute;mo acomodar&iacute;as algunas
				figuras dependindo del tamaño y figura de una caja.
			</p>
			<br>
			<div align="center">
				<img src="Imagenes_Temas/figuras.jpg" width="400" height="280" title="Figuras Geom&eacute;tricas">
            </div>
