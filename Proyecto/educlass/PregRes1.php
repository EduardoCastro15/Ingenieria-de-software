      ...
      <div id="contenido">
        ...
        <div id="section">
          <div class="article1"><br>
            <h3>¿Qui&eacute;n puede resolverme una duda o problema?</h3>    
            <p>
				El soporte administrador o soporte técnico puede resolverle cualquier duda si llena el siguiente formulario ubicado 
				en la pestaña <a href="Contacto.php" title="Cont&aacute;ctanos"><font color="black">Contacto</font></a> llenando 
				correctamente todos los campos, y a la brevedad posible se pondrá en contacto con usted resolviendo su duda.
            </p>
			<br>
            <div align="center"> 
				<img src="Imagenes/formulario.jpg" width="530" height="270" title="Ejemplo de como llenar el Formulario">
            </div>            
          </div> 
        </div>
